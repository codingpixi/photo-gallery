...
let albumArray = [
  {path: 'https://images.unsplash.com/photo-1490108661355-933af4ee68a1?dpr=2&auto=format&fit=crop&w=1500&h=987&q=80&cs=tinysrgb&crop=&bg=', // /images/pic1.png -is a path for a downloaded img
    albumTravel: [
  ...
  {path: '/images/pic4.png', //adjust initial phot path
    albumBirds: [
  ...
  {path: : '/images/pic1.png', //adjust initial phot path
    albumWater: [
...
// {/* in Album.js */}
// import data from './data.json'
// this.state = data[this.props.match.params.albumId]
//
// render () {
